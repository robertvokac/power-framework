...
public class JsonObjectTest {
    ...
    public void testJsonObject() {
        ...
        //assert
        //System.out.println(expectedString+" fff "+returnedString);
    ...
    /**
     * Test of hasKey method, of class JsonObject.
     */
    @Test
    public void testContainsValueWithKey() {
        ...
        jsonObject.addString("name", "John");
        jsonObject.addInt("age", 43);
        returnedValue = jsonObject.hasKey("nick");
        //assert
        assertEquals(expectedValue, returnedValue);
    }
    ...
    public void testContainsValueWithKey2() {
        ...
        jsonObject.addString("name", "John");
        jsonObject.addInt("age", 43);
        returnedValue = jsonObject.hasKey("nationality");
        //assert
        assertEquals(expectedValue, returnedValue);
    }
    ...
    public void testContainsValueWithKey3() {
        ...
        //act
        jsonObject.addString("personality", "calm");
        returnedValue = jsonObject.hasKey("personality");
        //assert
        assertEquals(expectedValue, returnedValue);
    }

    /**
     * Test of addJsonValue method, of class JsonObject.
     */
    @Test
    ...
    public void testAddNull() {
        ...
        returnedValue = jsonObject.hasKey("nothing");
        //assert
        assertEquals(expectedValue, returnedValue);
    }
    ...
    public void testAddObject() {
        ...
        returnedValue = jsonObject.hasKey("object");
        //assert
        assertEquals(expectedValue, returnedValue);
    }
    ...
    public void testAddArray() {
        ...
        returnedValue = jsonObject.hasKey("array");
        //assert
        assertEquals(expectedValue, returnedValue);
    }
    ...
    public void testAddBoolean() {
        ...
        returnedValue = jsonObject.hasKey("boolean");
        //assert
        assertEquals(expectedValue, returnedValue);
    }
    ...
    public void testAddString() {
        ...
        returnedValue = jsonObject.hasKey("String");
        //assert
        assertEquals(expectedValue, returnedValue);
    }
    ...
    public void testAddChar() {
        ...
        returnedValue = jsonObject.hasKey("char");
        //assert
        assertEquals(expectedValue, returnedValue);
    }
    ...
    public void testAddInt() {
        ...
        returnedValue = jsonObject.hasKey("int");
        //assert
        assertEquals(expectedValue, returnedValue);
    }
    ...
    public void testAddLong() {
        ...
        returnedValue = jsonObject.hasKey("long");
        //assert
        assertEquals(expectedValue, returnedValue);
    }
    ...
    public void testAddFloat() {
        ...
        returnedValue = jsonObject.hasKey("float");
        //assert
        assertEquals(expectedValue, returnedValue);
    }
    ...
    public void testAddDouble() {
        ...
        returnedValue = jsonObject.hasKey("double");
        //assert
        assertEquals(expectedValue, returnedValue);
    }
    ...
    /**
     * Test of isJsonValueType method, of class JsonObject.
     */
    @Test
    public void testIsJsonValueType() {
        //arrange
        JsonObject jsonObject = new JsonObject();
        JsonValueType jsonValueType = JsonValueType.DOUBLE;

        //act
        jsonObject.addDouble("double", 2.5d);
        //assert
        assertTrue(jsonObject.isJsonValueType("double", jsonValueType));
    }
    ...
    public void testGetCopy() {
        ...
        //assert
        System.out.println(expectedString + " " + returnedString);
        boolean result = expectedString.equals(returnedString);
        assertEquals(expectedString, returnedString);
    }
