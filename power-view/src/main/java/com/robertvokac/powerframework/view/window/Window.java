...
public abstract class Window extends Stage {
    ...
    private void setDefaultSizeAndPosition() {
        setWidth((com.robertvokac.powerframework.view.Screen.getVisualWidth()) / 2);
        setHeight((com.robertvokac.powerframework.view.Screen.getVisualHeight()) / 8 * 6);
        setX((com.robertvokac.powerframework.view.Screen.getVisualWidth() - this.getWidth()) / 2);
        setY((com.robertvokac.powerframework.view.Screen.getVisualHeight() - this.getHeight()) / 2);
    }
