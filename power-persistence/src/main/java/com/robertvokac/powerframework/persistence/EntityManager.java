...
import com.robertvokac.powerframework.sql.core.ColumnNameValue;
import com.robertvokac.powerframework.db.manager.Database;
import com.robertvokac.powerframework.sql.core.SqlStatementCreator;
...
public class EntityManager {
     ...
     */
    private static final com.robertvokac.powerframework.log.Logger LOG = com.robertvokac.powerframework.log.Logger.getLogger(EntityManager.class);
    ...
    private static void setAttribute(Object object, AttributeType attributeType, String javaName, String javaType, String valueIn) {
        switch (javaType) {
            ...
            case "com.robertvokac.powerframework.collections.bit.Blob": {
//                Integer value = Integer.valueOf(valueIn);
//                MethodInvocation.setInt(object, javaName, value);
            }
            break;
