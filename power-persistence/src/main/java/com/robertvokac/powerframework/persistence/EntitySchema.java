...
import com.robertvokac.powerframework.persistence.annotations.Entity;
import com.robertvokac.powerframework.persistence.annotations.EntityName;
import com.robertvokac.powerframework.utils.NamingConvention;
import com.robertvokac.powerframework.utils.annotations.Done;
...
public class EntitySchema {
     ...
     */
    private static final com.robertvokac.powerframework.log.Logger LOG = com.robertvokac.powerframework.log.Logger.getLogger(EntitySchema.class);
    ...
    private static String getEntityNameFromClass(Class clazz) {
        ...
        entityName = com.robertvokac.powerframework.utils.NamingConventionConvertor.convert(clazz.getName(), NamingConvention.JAVA_FIELD, NamingConvention.DATABASE);
        return entityName;
    }
