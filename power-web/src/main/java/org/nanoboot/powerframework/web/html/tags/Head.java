...
@Data
public class Head extends WebElement {
    public static final String NAME="head";
    public static final Set<String> ALLOWED_ELEMENTS= XmlUtils.createNewSet(Meta.NAME,Title.NAME,Link.NAME);
    public static final Set<String> ALLOWED_ATTRIBUTES
            = XmlUtils.createNewSet();


    public Head(XmlTypeI xmlTypes) {
        this();
    }
