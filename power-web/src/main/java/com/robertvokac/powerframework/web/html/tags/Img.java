...
import lombok.Data;
import com.robertvokac.powerframework.web.html.attributes.Height;
import com.robertvokac.powerframework.web.html.attributes.Src;
import com.robertvokac.powerframework.web.html.attributes.Width;
...
@Data
public final class Img extends WebElement {
    public static final String NAME = "img";


    public static final Set<String> ALLOWED_ATTRIBUTES
            = XmlUtils.createNewSet(Src.NAME, Width.NAME, Height.NAME);

    public Img(XmlTypeI xmlTypes) {
        this();
        add(xmlTypes);
    }
