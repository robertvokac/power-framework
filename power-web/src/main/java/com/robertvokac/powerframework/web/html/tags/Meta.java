...
import com.robertvokac.powerframework.web.html.attributes.Charset;
...
public final class Meta extends WebElement {
    public static final String NAME = "meta";

    public static final Set<String> ALLOWED_ATTRIBUTES
            = XmlUtils.createNewSet(HttpEquiv.NAME, Content.NAME, Charset.NAME);
