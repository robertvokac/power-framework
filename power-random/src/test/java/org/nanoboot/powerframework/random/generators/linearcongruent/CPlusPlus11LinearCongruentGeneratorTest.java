...
public class CPlusPlus11LinearCongruentGeneratorTest {
    /**
     * initial seed.
     */
    private static final long INITIAL_SEED = 100000;

    private CPlusPlus11LinearCongruentGenerator g;
    @Before
    public void setup() {
        g = new CPlusPlus11LinearCongruentGenerator(INITIAL_SEED);
    }
