...
/**
 * W5 generator processor interface.
 *
 * @author <a href="mailto:robertvokac@robertvokac.com">Robert Vokac</a>
 * @since 0.0.0
 */
public interface W5GeneratorsProcessor {
    /**
     * Computes next long using the generators.
     * @param generators generators.
     * @return next long using the generators
     */
    long next(CPlusPlus11LinearCongruentGenerator... generators);
}
