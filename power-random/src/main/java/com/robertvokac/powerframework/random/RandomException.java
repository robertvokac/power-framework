...
package com.robertvokac.powerframework.random;

import com.robertvokac.powerframework.core.PowerException;

/**
 * Exception happening in case, something in random packages failed.
 *
 * @author <a href="mailto:robertvokac@robertvokac.com">Robert Vokac</a>
 * @since 0.0.0
 */
public class RandomException extends PowerException {
